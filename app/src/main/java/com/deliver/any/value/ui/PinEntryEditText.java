package com.deliver.any.value.ui;

import static androidx.appcompat.R.attr.colorControlActivated;
import static androidx.appcompat.R.attr.colorControlHighlight;
import static androidx.appcompat.R.attr.colorPrimaryDark;
...
public class PinEntryEditText extends androidx.appcompat.widget.AppCompatEditText {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (!isInEditMode()) {
            ...
            context.getTheme().resolveAttribute(colorControlActivated,
                    outValue, true);
            final int colorActivated = outValue.data;
            mColors[0] = colorActivated;

            context.getTheme().resolveAttribute(colorPrimaryDark,
                    outValue, true);
            final int colorDark = outValue.data;
            mColors[1] = colorDark;

            context.getTheme().resolveAttribute(colorControlHighlight,
                    outValue, true);
